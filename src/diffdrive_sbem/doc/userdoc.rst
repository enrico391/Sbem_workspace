...
1. To check that *DiffBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch diffdrive_sbem view_robot.launch.py
...
2. To start *DiffBot* example open a terminal, source your ROS2-workspace and execute its launch file with
   ...
   .. code-block:: shell
    ...
    ros2 launch diffdrive_sbem diffbot.launch.py
...
6. Let's introspect the ros2_control hardware component. Calling
  ...
  .. code-block:: shell
    ...
    Hardware Component 1
            name: DiffBot
            type: system
            plugin name: diffdrive_sbem/DiffBotSystemHardware
  ...
  .. code-block:: shell
    ...
    ros2 launch diffdrive_sbem diffbot.launch.py use_mock_hardware:=True
