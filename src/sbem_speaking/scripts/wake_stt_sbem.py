...
class ProcessAudio(Node):
    ...
    def __init__(self):
        ...
        #     access_key='Qy998BQ4PVU+a9XsA1GaPZ1lwcukjuUs1GcFpc5ZwqEWWbsyj9Cadg==',
        ...
        self.model_wake_word = Model(inference_framework="tflite")

        self.start_record = False
        self.audio = pyaudio.PyAudio()
        self.stream_dict = {}
        self.data_audio = None
        self.f_name_directory = r"/home/morolinux/Documents/sbem_project_ws/src/sbem_speaking/samples"
    ...
    def get_audio(self, msg : AudioStamped) -> None:
        ...
        scores = list(self.model_wake_word.prediction_buffer["hey_jarvis"])
        ...
        if float(curr_score) > 0.7 and self.start_record == False:
        ...
        if os.path.isfile(os.path.join(self.f_name_directory, 'audio.wav')):
            ...
            segments, info = self.model.transcribe(os.path.join(self.f_name_directory, 'audio.wav'), beam_size=5,language="it")
